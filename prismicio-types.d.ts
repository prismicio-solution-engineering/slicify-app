...
/**
 * Item in *Catalogue → Default → Primary → Products*
 */
export interface CatalogueSliceDefaultPrimaryProductsItem {
  /**
...
/**
 * Primary content in *Catalogue → Default → Primary*
 */
export interface CatalogueSliceDefaultPrimary {
  /**
   * Theme field in *Catalogue → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: White
   * - **API ID Path**: catalogue.default.primary.theme
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  theme: prismic.SelectField<"White" | "Dark" | "Light" | "Blue", "filled">;

  /**
   * Title field in *Catalogue → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: catalogue.default.primary.title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.RichTextField;

  /**
   * Description field in *Catalogue → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: catalogue.default.primary.description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;

  /**
   * Products field in *Catalogue → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: catalogue.default.primary.products[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  products: prismic.GroupField<
    Simplify<CatalogueSliceDefaultPrimaryProductsItem>
  >;

  /**
   * anchor field in *Catalogue → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: catalogue.default.primary.anchor
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  anchor: prismic.KeyTextField;
}
...
/**
 * Default variation for Catalogue Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CatalogueSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<CatalogueSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Catalogue*
 */
type CatalogueSliceVariation = CatalogueSliceDefault;

/**
 * Catalogue Shared Slice
 *
 * - **API ID**: `catalogue`
 * - **Description**: Catalogue
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CatalogueSlice = prismic.SharedSlice<
  "catalogue",
  CatalogueSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      CallToActionSliceWithImageLeft,
      CatalogueSlice,
      CatalogueSliceDefaultPrimaryProductsItem,
      CatalogueSliceDefaultPrimary,
      CatalogueSliceVariation,
      CatalogueSliceDefault,
      FaqSlice,
