      ...
      <div className={clsx("mx-auto max-w-7xl px-4 sm:px-6 lg:px-8")}>
        <div className="mx-auto max-w-2xl lg:mx-0">
          <PrismicRichText
            ...
            components={{
              heading2: ({ children }) => (
                <h2 className="font-display text-4xl font-medium tracking-tighter text-vibrant-blue sm:text-5xl">
                  {children}
                </h2>
              ),
            }}
          ...
          <PrismicRichText
            ...
            components={{
              paragraph: ({ children }) => (
                <p className="mt-4 font-display text-2xl tracking-tight text-dark-blue">
                  {children}
                </p>
              ),
            }}
        ...
        <Tab.Group vertical={tabOrientation === "vertical"}>
          <div className="mt-14 grid grid-cols-1 items-start gap-x-8 gap-y-8 sm:mt-16 sm:gap-y-16 lg:mt-24 lg:grid-cols-4">
            <div className="relative -mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:block sm:overflow-visible sm:pb-0">
              <div className="absolute bottom-0 left-0.5 top-2 hidden w-px bg-light-blue-70 lg:block" />
                    ...
                    <div className="relative lg:pl-8">
                      <DiamondIcon
                        className={clsx(
                          ...
                          1 === selectedIndex
                            ? "fill-light-blue stroke-light-blue"
                            : "fill-transparent stroke-vibrant-blue"
                        )}
                      />
                      <div className="relative">
                        ...
                        >
                          <Tab className="ui-not-focus-visible:outline-none">
                            ...
                            <div className="mt-1.5 block text-2xl font-semibold tracking-tight text-light-blue">
